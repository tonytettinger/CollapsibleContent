...
module.exports = function ( moduleRoot ) {
	...
	var moduleSettings = {
		...
		domain: 'http://localhost:8888/knowthecodeplugin',
		...
		i18n: {
			...
			bugReport: 'https://clovio.com',
			lastTranslator: 'Antal <antal.tettinger@clovio.om>',
			team: 'Team <hello@clovio.com>'
		}
	};
	...
	var watchSettings = {
		browserSync:	{
			open: false,   
			port: 8888,          // Open project in a new tab?
